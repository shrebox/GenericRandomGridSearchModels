...
for threshold in thresholdRange:
    ...
    for i in range(iter):
        ...
        for train_index, test_index in skf.split(X_train, Y_train):
            ...
            bp = best_params[i]
            clf = MLPClassifier(hidden_layer_sizes=bp['hidden_layer_sizes'], activation=bp['activation'],
                                solver=bp['solver'], alpha=bp['alpha'], max_iter=bp['max_iter'],
                                random_state=seed).fit(X_tr, Y_tr.ravel())
